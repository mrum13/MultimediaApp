...
public class Datavalues {
    ...
    public static final String[] namafilm = {"A Star","Aquaman","Avenger: Infinity War","Birdbox", "Bohemian","Bumblebee",
            "Creed","Deadpool I","Dragon","Dragon Ball","Glasss","Hunterkiller",
            "Mortal Engine","Robinhood","Spiderman I"};
    public static final int[] gambarfilm = {R.drawable.poster_a_star,
    ...
    public static final String [] detailfilm = {"Seasoned musician Jackson Maine discovers — and falls in love with — struggling artist Ally. She has just about given up on her dream to make it big as a singer — until Jack coaxes her into the spotlight. But even as Allys career takes off, the personal",
            ...
            "Singer Freddie Mercury, guitarist Brian May, drummer Roger Taylor and bass guitarist John Deacon take the music world by storm when they form the rock n roll band Queen in 1970. Hit songs become instant classics. When Mercurys increasingly wild lifestyle starts to spiral out of control",
            ...
            "When danger mounts at home and Hiccup’s reign as village chief is tested, both dragon and rider must make impossible decisions to save their kind Jaga Bada, Mr. Satans old sparring partner, has invited Satan to his personal island to hold a grudge match.",
            "A war-hardened Crusader and his Moorish commander mount an audacious revolt against the corrupt English crown.",
            "Following the events of Captain America: Civil War, Peter Parker, with the help of his mentor Tony Stark, tries to balance his life as an ordinary high school student in Queens, New York City, with fighting crime as his superhero alter ego Spider-Man as a new threat, the Vulture, emerges."
    };

    public static final String[] casts = {"Bradley Cooper,Lady Gaga,Sam Elliott",
            ...
            "Masako Nozawa(voice),Takeshi Kusao(voice)",
            "James McAvoy,Bruce Willis,Samuel L. Jackson",
            "Gerard Butler,Gary Oldman",
            "Hera Hilmar,Robert Sheehan",
            "Taron Egerton,Jamie Foxx,Eve Hewson",
            "Tom Holland,Robert Downey Jr.,Jon Favreau"
    };
}
